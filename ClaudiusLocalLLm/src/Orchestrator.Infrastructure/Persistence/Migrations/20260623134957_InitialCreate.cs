        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GitRemote = table.Column<string>(type: "text", nullable: true),
                    LocalModel = table.Column<string>(type: "text", nullable: false),
                    CloudModel = table.Column<string>(type: "text", nullable: false),
                    MaxWorkerConcurrency = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByRunId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExitSummaryJson = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_Lane_State_Priority",
                table: "Tasks",
                columns: new[] { "Lane", "State", "Priority" });
