    ...
    List<MountingHoleDto> MountingHoles)
{
    public static ProjectDetailDto FromEntity(TagProject p) => new(
        ...
        p.BevelMm,
        p.CharmPlateWidthMm,
        p.CharmPlateHeightMm,
        p.CharmHookOuterRadiusMm,
        p.CharmHookBandThicknessMm,
        p.ClipPlateWidthMm,
        p.ClipPlateHeightMm,
        p.ClipArmLengthMm,
        p.ClipGapMm,
        p.ClipArmThicknessMm,
        p.CreatedAt,
...
public sealed record SaveProjectDto(
    ...
    float BevelMm = 0f,
    float CharmPlateWidthMm = 28f,
    float CharmPlateHeightMm = 13f,
    float CharmHookOuterRadiusMm = 6f,
    float CharmHookBandThicknessMm = 1.8f,
    float ClipPlateWidthMm = 55f,
    float ClipPlateHeightMm = 22f,
    float ClipArmLengthMm = 20f,
    float ClipGapMm = 2.4f,
    float ClipArmThicknessMm = 1.2f,
